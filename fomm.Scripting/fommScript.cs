    ...
    public static class fommScript {
        ...
        private static bool FunctionIf(string[] line) {
            ...
            case "DataFileExists":
                ...
                return ScriptFunctions.GetExistingDataFileList(Path.GetDirectoryName(line[2]), Path.GetFileName(line[2]), false).Length==1;
            case "FommNewerThan":
                if(line.Length==2) {
                ...
                try {
                    return ScriptFunctions.GetFalloutVersion()>=new Version(line[2]+".0");
                } catch {
            ...
            case "ScriptExtenderPresent":
                ...
                return ScriptFunctions.ScriptExtenderPresent();
            case "ScriptExtenderNewerThan":
                ...
                if(!ScriptFunctions.ScriptExtenderPresent()) return false;
                try {
                    return ScriptFunctions.GetFoseVersion()>=new Version(line[2]+".0");
                } catch {
        ...
        private static string[] FunctionSelect(string[] line, bool many, bool Previews, bool Descriptions) {
            ...
            //Display select form
            int[] indices=ScriptFunctions.Select(items, previews, descs, title, many);
        ...
        private static FlowControlStruct FunctionFor(string[] line, int LineNo) {
            ...
            case "DataFile": {
                    ...
                    return new FlowControlStruct(ScriptFunctions.GetFomodFileList(), line[3], LineNo);
                }
            }
            return NullLoop;
        }
        ...
        private static void FunctionMessage(string[] line) {
            ...
            case 1:
                ...
                break;
            case 2:
                ScriptFunctions.MessageBox(line[1]);
                break;
            case 3:
                ScriptFunctions.MessageBox(line[1], line[2]);
                break;
            default:
        ...
        private static void FunctionSetPluginActivation(string[] line) {
            ...
            if(line[2]=="True") ScriptFunctions.SetPluginActivation(line[1], true);
            else if(line[2]=="False") ScriptFunctions.SetPluginActivation(line[1], false);
        ...
        private static void FunctionEditINI(string[] line,IniType type) {
            ...
            case IniType.Fallout:
                ScriptFunctions.EditFalloutINI(line[1], line[2], line[3], true);
                break;
            case IniType.FalloutPrefs:
                ScriptFunctions.EditPrefsINI(line[1], line[2], line[3], true);
                break;
            case IniType.Geck:
                ScriptFunctions.EditGeckINI(line[1], line[2], line[3], true);
                break;
            case IniType.GeckPrefs:
                ScriptFunctions.EditGeckPrefsINI(line[1], line[2], line[3], true);
                break;
            }
        }
        ...
        private static void FunctionEditShader(string[] line) {
            ...
            ScriptFunctions.EditShader(package, line[2], ScriptFunctions.GetFileFromFomod(line[3]));
        }
        ...
        private static void FunctionReadINI(string[] line, IniType type) {
            ...
            switch(type) {
            case IniType.Fallout:
                variables[line[1]]=ScriptFunctions.GetFalloutIniString(line[2], line[3]);
                break;
            case IniType.FalloutPrefs:
                variables[line[1]]=ScriptFunctions.GetPrefsIniString(line[2], line[3]);
                break;
            case IniType.Geck:
                variables[line[1]]=ScriptFunctions.GetGeckIniString(line[2], line[3]);
                break;
            case IniType.GeckPrefs:
                variables[line[1]]=ScriptFunctions.GetGeckPrefsIniString(line[2], line[3]);
                break;
            }
        }
        ...
        private static void FunctionReadRenderer(string[] line) {
            ...
            variables[line[1]]=ScriptFunctions.GetRendererInfo(line[2]);
        }
        ...
        public static bool Execute(string InputScript) {
