      ...
      for (int j = 0; j < boxes.Count; j++)
      {
        ...
        switch (valueTypes[j])
        {
          case ElementValueType.Byte:
          {
            ...
            {
              MessageBox.Show("Invalid byte: " + boxes[j].Text, Resources.ErrorStr);
              return;
            }
            bytes.Add(b);
            break;
          ...
          case ElementValueType.Short:
          {
            ...
            {
              MessageBox.Show("Invalid short: " + boxes[j].Text, Resources.ErrorStr);
              return;
            }
          ...
          case ElementValueType.Int:
          {
            ...
            {
              MessageBox.Show("Invalid int: " + boxes[j].Text, Resources.ErrorStr);
              return;
            }
          ...
          case ElementValueType.Float:
          {
            ...
            {
              MessageBox.Show("Invalid float: " + boxes[j].Text, Resources.ErrorStr);
              return;
            }
          ...
          case ElementValueType.FormID:
          {
            ...
            {
              MessageBox.Show("Invalid formID: " + boxes[j].Text, Resources.ErrorStr);
              return;
            }
