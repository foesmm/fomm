...
namespace Fomm.Games.Fallout3.Tools
{
  public static class ArchiveInvalidation
  {
    ...
    private static void ApplyAI()
    {
      ...
      NativeMethods.WritePrivateProfileIntA("Archive", "bInvalidateOlderFiles", 1,
                                            ((Fallout3GameMode.SettingsFilesSet) Program.GameMode.SettingsFiles)
                                              .FOIniPath);
      NativeMethods.WritePrivateProfileIntA("General", "bLoadFaceGenHeadEGTFiles", 1,
                                            ((Fallout3GameMode.SettingsFilesSet) Program.GameMode.SettingsFiles)
                                              .FOIniPath);
      NativeMethods.WritePrivateProfileStringA("Archive", "SInvalidationFile", "",
                                               ((Fallout3GameMode.SettingsFilesSet) Program.GameMode.SettingsFiles)
                                                 .FOIniPath);
      ...
      NativeMethods.WritePrivateProfileStringA("Archive", "SArchiveList", AiBsa + ", " + GetBSAList(),
                                               ((Fallout3GameMode.SettingsFilesSet) Program.GameMode.SettingsFiles)
                                                 .FOIniPath);
    }
    ...
    {
      NativeMethods.WritePrivateProfileIntA("Archive", "bInvalidateOlderFiles", 0,
                                            ((Fallout3GameMode.SettingsFilesSet) Program.GameMode.SettingsFiles)
                                              .FOIniPath);
      NativeMethods.WritePrivateProfileIntA("General", "bLoadFaceGenHeadEGTFiles", 0,
                                            ((Fallout3GameMode.SettingsFilesSet) Program.GameMode.SettingsFiles)
                                              .FOIniPath);
      NativeMethods.WritePrivateProfileStringA("Archive", "SInvalidationFile", "ArchiveInvalidation.txt",
                                               ((Fallout3GameMode.SettingsFilesSet) Program.GameMode.SettingsFiles)
                                                 .FOIniPath);
      File.Delete(Path.Combine(Program.GameMode.PluginsPath, AiBsa));
      NativeMethods.WritePrivateProfileStringA("Archive", "SArchiveList", GetBSAList(),
                                               ((Fallout3GameMode.SettingsFilesSet) Program.GameMode.SettingsFiles)
                                                 .FOIniPath);
    }
