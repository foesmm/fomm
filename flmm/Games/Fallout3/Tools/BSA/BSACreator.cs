  ...
  internal partial class BSACreator : Form
  {
    ...
    private class ListViewSorter : IComparer
    {
      public int Compare(object oa, object ob)
      {
        ...
        int i = String.CompareOrdinal(Path.GetDirectoryName(a.Text), Path.GetDirectoryName(b.Text));
        if (i != 0)
        {
          return i;
        }
        return String.CompareOrdinal(Path.GetFileName(a.Text), Path.GetFileName(b.Text));
      }
    }
