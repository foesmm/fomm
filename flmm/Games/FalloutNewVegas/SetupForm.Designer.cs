namespace Fomm.Games.FalloutNewVegas
{
	partial class SetupForm
	{
		...
		private void InitializeComponent()
		{
			...
			this.label1.Text = "Fallout: New Vegas Setup";
			// 
			// pnlShadow
			// 
			...
			this.Text = "Fallout: New Vegas Setup";
		...
		private Fomm.Games.FalloutNewVegas.Settings.RequiredDirectoriesControl rdcDirectories;
