...
namespace Fomm
{
  public partial class PluginFormat
  {
    ...
    public class PluginFormatterManager
    {
      ...
      /// </remarks>
      /// <param name="p_ffmFontFamily">
      ///   The desired font family, or <lang langref="null" /> if the format won't affect the font
      ///   family.
      /// </param>
      /// <param name="p_fltFontSizeEM">
      ///   The desired font size in em-points, or <lang langref="null" /> if the format won't affect
      ///   the font size.
      /// </param>
      /// <param name="p_fstFontStyle">
      ///   The desired font style, or <lang langref="null" /> if the format won't affect the font
      ///   style.
      /// </param>
      /// <param name="p_clrColour">
      ///   The desired font colour, or <lang langref="null" /> if the format won't affect the font
      ///   colour.
      /// </param>
      /// <param name="p_clrHighlight">
      ///   The desired highlight colour, or <lang langref="null" /> if the format won't affect the
      ///   highlight colour.
      /// </param>
