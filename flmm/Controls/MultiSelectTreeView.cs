...
namespace Fomm.Controls
{
  ...
  public class MultiSelectTreeView : TreeView
  {
    ...
    public class TreeNodeCollection : IList<TreeNode>
    {
      ...
      {
        private readonly TreeNode m_tndNode;
      ...
      private readonly LinkedList<TreeNode> m_lklNodes = new LinkedList<TreeNode>();
    ...
    private readonly TreeNodeCollection m_tncSelectedNodes;
    ...
    public MultiSelectTreeView()
    {
      ...
      m_tncSelectedNodes.ItemAdded += m_tncSelectedNodes_ItemAdded;
      m_tncSelectedNodes.ItemRemoved += m_tncSelectedNodes_ItemRemoved;
    }
    ...
    private void m_tncSelectedNodes_ItemRemoved(object sender, TreeNodeCollection.TreeNodeEventArgs e)
    {
