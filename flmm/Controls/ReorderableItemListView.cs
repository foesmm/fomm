...
namespace Fomm.Controls
{
  ...
  internal class ReordableItemListView : ListView
  {
    ...
    {
      Point pt = PointToClient(location);
      int lastItemBottom = Math.Min(pt.Y, Items[Items.Count - 1].GetBounds(ItemBoundsPortion.Entire).Bottom - 1);
    ...
    private readonly List<ListViewItem> _ItemsToMove = new List<ListViewItem>();
    private bool _PauseItemDrag;
    private readonly object _DragKey = new object();
