...
namespace ICSharpCode.SharpZipLib.Zip.Compression
{
  ...
  internal static class DeflaterConstants
  {
    ...
    /// Internal compression engine constant
    /// </summary>    
    public static readonly int[] GOOD_LENGTH =
    {
    ...
    /// Internal compression engine constant
    /// </summary>    
    public static readonly int[] MAX_LAZY =
    {
    ...
    /// Internal compression engine constant
    /// </summary>    
    public static readonly int[] NICE_LENGTH =
    {
    ...
    /// Internal compression engine constant
    /// </summary>    
    public static readonly int[] MAX_CHAIN =
    {
    ...
    /// Internal compression engine constant
    /// </summary>    
    public static readonly int[] COMPR_FUNC =
    {
      0, 1, 1, 1, 1, 2, 2, 2, 2, 2
    };
  }
