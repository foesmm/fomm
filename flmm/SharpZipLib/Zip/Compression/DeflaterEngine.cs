...
*/
    ...
    private bool FindLongestMatch(int curMatch)
    {
      ...
      */
      if (lNiceLength > lookahead)
      {
        lNiceLength = lookahead;
      }
      ...
      while ((curMatch = (lPrev[curMatch & DeflaterConstants.WMASK] & 0xffff)) > limit && --chainLength != 0);
