...
namespace Fomm.PackageManager
{
	partial class InfoEditor : Form
	{
		...
		private void bScreenshot_Click(object sender, EventArgs e)
		{
			...
			setScreenshot = true;
			m_shtScreenshot = new Screenshot(openFileDialog1.FileName, System.IO.File.ReadAllBytes(openFileDialog1.FileName));
		}
		...
		private void bSave_Click(object sender, EventArgs e)
		{
			...
			mod.CommitInfo(setScreenshot, m_shtScreenshot);
