...
namespace Fomm.PackageManager.XmlConfiguredInstall.Parsers
{
  ...
  public abstract class Parser
  {
    ...
    public static Parser GetParser(XmlDocument p_xmlConfig, fomod p_fomodMod, DependencyStateManager p_dsmSate)
    {
      ...
      Int32 intStartPos = strSchemaName.LastIndexOf("modconfig", StringComparison.Ordinal) + 9;
      if (intStartPos > 8)
      {
    ...
    protected Parser(XmlDocument p_xmlConfig, fomod p_fomodMod, DependencyStateManager p_dsmSate,
