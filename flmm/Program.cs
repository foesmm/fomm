...
namespace Fomm
{
  ...
  public static class Program
  {
    ...
    private static void Main(string[] args)
    {
      ...
      do
      {
        ...
        switch (sgmSelectedGame)
        {
          ...
          default:
            MessageBox.Show("Unrecognized game selection.", Resources.ErrorStr, MessageBoxButtons.OK,
        ...
        if (!booNewMutex)
        {
          MessageBox.Show(ProgrammeAcronym + " is already running", Resources.ErrorStr, MessageBoxButtons.OK,
                          MessageBoxIcon.Error);
          mutex.Close();
          return;
        }
        ...
        try
        {
          ...
          {
            MessageBox.Show(null, strErrorMessage, Resources.ErrorStr, MessageBoxButtons.OK, MessageBoxIcon.Error);
          ...
          if (!Settings.Default.NoUACCheck || Array.IndexOf(args, "-no-uac-check") == -1)
          {
            ...
            catch
            {
              MessageBox.Show(
                ...
                Path.Combine(ProgrammeInfoDirectory, "Readme - fomm.txt") + Environment.NewLine + "for the solution.",
                Resources.ErrorStr, MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
          }
          else
          {
          ...
          if (booChangeGameMode || !GameMode.HandleInAppArguments(args))
          {
            ...
            {
              HandleException(e, "Something bad seems to have happened.", Resources.ErrorStr);
            }
          }
    ...
    {
      HandleException(e.Exception, "Something bad seems to have happened.", Resources.ErrorStr);
      Application.ExitThread();
    }

    private static void CurrentDomain_UnhandledException(object sender, UnhandledExceptionEventArgs e)
    {
      HandleException(e.ExceptionObject as Exception, "Something bad seems to have happened.", Resources.ErrorStr);
    }
